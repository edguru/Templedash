          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              <div className="text-center p-3 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm font-medium text-gray-700">Smart Chat</p>
              </div>
              <div className="text-center p-3 bg-green-50 rounded-lg">
                <Zap className="text-green-500 mx-auto mb-2" size={24} />
                <p className="text-sm font-medium text-gray-700">Task Automation</p>
              </div>
              <div className="text-center p-3 bg-purple-50 rounded-lg">
                <Heart className="text-purple-500 mx-auto mb-2" size={24} />
      ...
      content: (
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Customize Your Companion</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-4 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors">
              <h4 className="font-semibold text-gray-800 mb-2">Relationship Type</h4>
              <ul className="text-sm text-gray-600 space-y-1">
      ...
      content: (
        <div className="space-y-6">
          <div className="text-center mb-6">
            <Zap className="text-yellow-500 mx-auto mb-3" size={48} />
            <h3 className="text-xl font-bold text-gray-800">Your Companion's Superpowers</h3>
          </div>
          ...
          <div className="grid gap-4">
            <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-800">Intelligent Conversations</h4>
                <p className="text-sm text-gray-600">Natural language processing with context awareness and memory</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg">
              ...
              <div>
                <h4 className="font-semibold text-gray-800">Web3 Task Automation</h4>
                <p className="text-sm text-gray-600">Execute blockchain transactions, check balances, and manage NFTs</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Adapts to your preferences and grows smarter over time</p>
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-bold text-gray-800">You're Ready to Begin!</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
            <div className="flex items-center justify-center space-x-2 text-green-700">
              <Heart size={20} />
              <span className="font-medium">One companion per wallet - Make it count!</span>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold text-gray-900">Companion Onboarding</h1>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <button
            onClick={handleNext}
            className="flex items-center space-x-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all"
          >
            <span>
              {currentStep === tutorialSteps.length - 1 ? 'Create My Companion' : 'Next'}
            </span>
